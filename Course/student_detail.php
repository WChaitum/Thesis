...
<div class="card mt-5">
  ...
  <thead>
    ...
    <div class="card-header text-center">
      ...
      <th scope="col">RFID นักเรียน</th>
      <th scope="col">ชื่อ-นามสกุล</th>
      <th scope="col">RFID ผู้ปกครอง</th>
      <th scope="col">รูปภาพ</th>
      <th scope="col">เสียงเรียก</th>
  ...
  ?>
    ...
    <tr>
      ...
      <td><?php echo $row['parent_rfid'];?></td>
      <td><img src = "student_picture/<?php echo $row['picture'];?>"width="50px"heigh="50px"></td>
      ...
      <!--<td><button type="button" class="btn btn-warning"><a href = "student_edit.php?id=<?php echo $row['id'];?>">แก้ไข</a></button></td>-->
      <td><a class="btn btn-warning" href="student_edit.php?id=<?php echo $row['id'];?>"><svg class="bi bi-gear" width="1.4em" height="1.4em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M10 7.754a2.246 2.246 0 100 4.492 2.246 2.246 0 000-4.492zM6.754 10a3.246 3.246 0 116.492 0 3.246 3.246 0 01-6.492 0z" clip-rule="evenodd"></path>
      ...
      <!--<td><button type="button" class="btn btn-danger"><a href = "student_delete.php?id=<?php echo $row['id'];?>">ลบ</a></button></td>-->
      <td><a class="btn btn-danger" href="student_delete.php?id=<?php echo $row['id'];?>"><svg class="bi bi-trash-fill" width="1.4em" height="1.4em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
